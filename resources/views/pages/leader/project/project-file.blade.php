      ...
      <div class="container">
        ...
        <div class="row form-add-file mb-3">
          <div class="col-12">
            ...
            <form action="{{ route('project-file-leader-upload', $project->id) }}" method="POST" enctype="multipart/form-data">
              @csrf
              ...
              <div class="card-body">
                <ul class="list-group">
                  ...
                  <li class="list-group-item d-md-flex  justify-content-between align-items-center">
                    {{ $item->file_name }}
                    <span class="d-block">
                      <a href="{{ route('project-file-leader-download', $item->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-download"></i> Download</a>
                      <form class="d-inline" action="{{ route('project-file-leader-delete', $item->id) }}" method="post">
                        @method('Delete')
                        @csrf
